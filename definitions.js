...
export const CARIBBEAN = 'Caribbean Region';
export const CHILE = 'Chile';
export const CHINA = 'China';
export const CHINA_HONGKONG = 'Hong Kong (China)';
...
export const UNITED_ARAB_EMIRATES = 'United Arad Emirates';
export const UNITED_KINGDON = 'United Kingdom';
export const UK_LONDON = 'London (UK)';

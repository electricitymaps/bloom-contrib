...
const METERING_POINT_ID_1 = '57131317910012203822';
const METERING_POINT_ID_2 = '57131317910012203823';
...
const getSmartMeter = (meteringPointId) => ({
  meteringPointId,
  typeOfMP: 'E17',
...
const getTimeSeriesEntry = (meteringPointId) => ({
...
const RESPONSE = {
  ...
  METERING_POINT_API_RESPONSE: mockSuccessJSONResponse(
    JSON.stringify({
...
describe('collect', () => {
  it('support one smart meter', async () => {
    setDate('2020-10-11T22:00:00Z');
  ...
  it('supports multiple smart meters', async () => {
    setDate('2020-10-11T22:00:00Z');
    const toDate = moment.min(moment(FROM_DATE).add(14, 'days'), moment());
    mockPathToResult = {
      [RESOURCES.ACCESS_TOKEN]: [RESPONSE.ACCESS_TOKEN_API_RESPONSE],
